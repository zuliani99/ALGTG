...
class Cifar10SubsetDataloaders():
    ...
    def __init__(self, batch_size, val_rateo, labeled_ratio, normalize_train = False):
        ...
        if self.normalize_train: self.original_trainset.get_std_mean_train()
...
class CIFAR10(Dataset):
    ...
    def get_std_mean_train(self):
        # not necessarly since I acces to self.cifar10 with is the original dataset and not from my overload of Dataset
