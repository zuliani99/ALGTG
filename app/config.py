        ...
        'optimizers': {
            'backbone':{
                ...
                'optim_p': {
                    ...
                    'GTGModule': { 'lr': 0.1, 'momentum': 0.9, 'weight_decay': 5e-4 }, #0.01 -> LSTM
                }
            },
            'modules': {
                'type': { 'LossNet': torch.optim.SGD, 'GTGModule': torch.optim.Adam, },#, Adam }
                'decay': { 'LossNet': 120, 'GTGModule': 120 }, #200
                'optim_p': {
                    'LossNet': { 'lr': 0.1, 'momentum': 0.9, 'weight_decay': 5e-4 },
                    'GTGModule': { 'lr': 0.001, } #'weight_decay': 0.001} #, 'momentum': 0.9, 'weight_decay': 5e-4 }, # SGD with 0.005 work, Adam with lr=0.001 only works
                    #0.001 -> LSTM
                }
            }
        }
